...
import 'package:grojha/screens/order_details/pending_order_details/components/single_order_details_product_card.dart';
...
class Details extends StatefulWidget {
  const Details({Key key, this.order, this.notifyParent}) : super(key: key);
